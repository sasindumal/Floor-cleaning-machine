...
#define USFL_TRIG_PIN A1
#define USFL_ECHO_PIN A0
#define USFR_TRIG_PIN 13
#define USFR_ECHO_PIN 10
#define USL_TRIG_PIN A3
#define USL_ECHO_PIN A2
#define USR_TRIG_PIN A5
#define USR_ECHO_PIN A4
...
NewPing sonarUsfl(USFL_TRIG_PIN, USFL_ECHO_PIN, MAX_DISTANCE);
NewPing sonarUsfr(USFR_TRIG_PIN, USFR_ECHO_PIN, MAX_DISTANCE);
NewPing sonarUsr(USR_TRIG_PIN, USR_ECHO_PIN, MAX_DISTANCE);
NewPing sonarUsl(USL_TRIG_PIN, USL_ECHO_PIN, MAX_DISTANCE);
...
int readUsf() {
  int distancel = sonarUsfl.ping_cm();
  int distancer = sonarUsfr.ping_cm();
